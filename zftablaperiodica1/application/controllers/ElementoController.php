<?php
class ElementoController extends Zend_Controller_Action
{
   ...
   private $_listado = null;
    ...
    public function init()
    {
          ...
          $this->_listado= new Application_Model_ElementoDao(); //se pone aqui para actualizar para todo
          $this->_buscarPorId= new Application_Model_ElementoDao();
    }
    ...
    public function listadoAction()
    {
       ...
       // var_dump($this-> _listado->listado()); //var_dump es para imprimr un array objeto ;imprime el metod listado de UserDao
        $this->view->listaElemento=$this->_listado->listado();//despues
    }
    ...
    public function buscarporidAction()
    {
        ...
        if($id<14 && $id>0){
            $this->view->id=$id;
          $buscarPorId=new  Application_Model_ElementoDao();
          $Elemento=$buscarPorId->buscarPorId($id);
          $this->view->listaElemento=array($Elemento);
          $this->render('listado');
        }else{
           $this->_redirect('Elemento/listado'); //Tambien puede usarse $this->_forward('listado');
        }
    ...
    public function eliminarAction()
    {
        // action body
         ...
         $Elemento=new  Application_Model_ElementoDao();
         $resultado=$Elemento->eliminar($id);
         $this->view->listaElemento=$resultado;
         $this->render('listado');
         //echo $id;
    }
